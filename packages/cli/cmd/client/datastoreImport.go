...
import (
	...
	"github.com/cogment/cogment/clients/datastore"
...
var datastoreImportCmd = &cobra.Command{
	...
	RunE: func(_cmd *cobra.Command, args []string) error {
		...
		datastoreEndpoint, err := endpoint.Parse(datastoreViper.GetString(datastoreEndpointKey))
		if err != nil {
			return err
		}

		client, err := datastore.CreateClientWithInsecureEndpoint(datastoreEndpoint)
		if err != nil {
			return err
		}
