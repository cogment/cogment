...
var expectedConfig, _ = api.ExtendDefaultProjectConfig(&api.ProjectConfig{
	...
	TrialParams: &api.TrialParams{
		Actors: []*api.TrialActor{
			{Name: "client_actor", ActorClass: "master", Implementation: "client_actor_impl", Endpoint: "client"},
			{
				Name:           "smart_smart_impl_1",
				ActorClass:     "smart",
				Implementation: "smart_impl",
				Endpoint:       "grpc://smart-impl:9000",
			},
			{Name: "dumb_dumb_impl_1", ActorClass: "dumb", Implementation: "dumb_impl", Endpoint: "grpc://dumb-impl:9000"},
		},
	},
	WebClient:  true,
	Typescript: true,
	...
	config, err := api.ExtendDefaultProjectConfig(&api.ProjectConfig{
		...
		TrialParams: &api.TrialParams{
			Actors: []*api.TrialActor{
				...
				{Name: "ai_1", ActorClass: "smart", Implementation: "smart_impl", Endpoint: "grpc://smart:9000"},
				{Name: "ai_2", ActorClass: "dumb", Implementation: "dumb_impl", Endpoint: "grpc://dumb:9000"},
			},
		},
	})
	assert.NoError(t, err)
...
func TestCreateProjectFilesDashes(t *testing.T) {
	...
	dir, err := os.MkdirTemp("", "TestCreateProjectFilesDashes")
	...
	config, err := api.ExtendDefaultProjectConfig(&api.ProjectConfig{
		...
		TrialParams: &api.TrialParams{
			Actors: []*api.TrialActor{
				{ActorClass: "smart", Endpoint: "grpc://smart:9000"},
				{ActorClass: "dumb", Endpoint: "grpc://dumb:9000"},
			},
		},
	})
	assert.NoError(t, err)
