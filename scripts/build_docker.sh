...
if [[ -z "${COGMENT_MODEL_REGISTRY_IMAGE_BUILD_CACHE}" ]]; then
  COGMENT_MODEL_REGISTRY_IMAGE_BUILD_CACHE="registry.github.com/cogment/model-registry/build:latest"
...
if [[ -z "${COGMENT_MODEL_REGISTRY_IMAGE_BUILD}" ]]; then
  COGMENT_MODEL_REGISTRY_IMAGE_BUILD="registry.github.com/cogment/model-registry/build:local"
