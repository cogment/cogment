...
class ActorService {
 ...
 public:
  ...
  ::easy_grpc::Future<::cogment::TrialJoinReply> JoinTrial(
  ...
  ::easy_grpc::Future<::cogment::TrialHeartbeatReply> Heartbeat(
      ::cogment::TrialHeartbeatRequest, easy_grpc::Context ctx);
  ::easy_grpc::Future<::cogment::TrialFeedbackReply> GiveFeedback(
